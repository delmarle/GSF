...
namespace Dispatcher
{
	...
	public static class EventManager
	{
			...
			EventSendMode mode = EventSendMode.Default) where T : struct
		{
			...
			// system.
			Helper.SendEventWithSystem(ev, UnityEventSystem<T>.Global, mode);
		...
		private const string HelperName = "[EventManager Helper]";

		private static LocalEventSystem Helper
		{
			get
			{
				if (_mHelper == null)
				{
					GameObject obj = new GameObject(HelperName);
